...
RUN pnpm db:generate && pnpm --filter @ticketwatch/shared build && pnpm --filter @ticketwatch/scraper-core build && pnpm --filter @ticketwatch/notification-core build && pnpm --filter @ticketwatch/database build && pnpm --filter @ticketwatch/api build
